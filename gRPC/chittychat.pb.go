...
var file_gRPC_chittychat_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x94, 0x01, 0x0a, 0x0a, 0x43, 0x68, 0x69, 0x74, 0x74,
...
var file_gRPC_chittychat_proto_depIdxs = []int32{
	...
	2, // 2: ChittyChat.GetMessages:input_type -> ClientId
	4, // 3: ChittyChat.PostMessage:input_type -> MessagePackage
	3, // 4: ChittyChat.CreateClientIdentifier:input_type -> Empty
	4, // 5: ChittyChat.GetMessages:output_type -> MessagePackage
	3, // 6: ChittyChat.PostMessage:output_type -> Empty
	2, // 7: ChittyChat.CreateClientIdentifier:output_type -> ClientId
